...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("info.kotocoin.electrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "info.kotocoin.electrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "info.kotocoin.electrum:externalType",
                '',
                data)
        return extRecord
    ...
    def _nfc_enable_ndef_exchange(self, data):
        ...
        ndef_record = NdefRecord(
                ...
                'info.kotocoin.electrum.kivy', '', data)
