...
;Variables
  ...
  !define PRODUCT_NAME "Electrum for Koto"
  !define PRODUCT_WEB_SITE "https://github.com/wo01/electrum-koto"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum-koto\icons\kotocolor_back.ico"
...
Section
  ...
  File "c:\electrum-koto\icons\kotocolor_back.ico"
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-koto-${PRODUCT_VERSION}.exe" ""

  ;Create start-menu items
  DetailPrint "Creating start-menu items..."
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Uninstall.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\Uninstall.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-koto-${PRODUCT_VERSION}.exe" "" "$INSTDIR\electrum-koto-${PRODUCT_VERSION}.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME} Testnet.lnk" "$INSTDIR\electrum-koto-${PRODUCT_VERSION}.exe" "--testnet" "$INSTDIR\electrum-koto-${PRODUCT_VERSION}.exe" 0
  ...
  WriteRegStr HKCU "Software\Classes\koto" "DefaultIcon" "$\"$INSTDIR\kotocolor_back.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\koto\shell\open\command" "" "$\"$INSTDIR\electrum-koto-${PRODUCT_VERSION}.exe$\" $\"%1$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\kotocolor_back.ico"
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\koto"
