...
Label.register(
    'JP',
    KIVY_GUI_PATH + '/data/fonts/GenShinGothic-P-Normal.ttf',
    KIVY_GUI_PATH + '/data/fonts/GenShinGothic-P-Normal.ttf',
    KIVY_GUI_PATH + '/data/fonts/GenShinGothic-P-Bold.ttf',
    KIVY_GUI_PATH + '/data/fonts/GenShinGothic-P-Bold.ttf',
)
...
class ElectrumWindow(App, Logger):
    ...
    def init_ui(self):
        ...
        self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/kotocolor.png"
